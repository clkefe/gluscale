...
export default function Home() {
  ...
  const { user, loading, authenticated, signOut, signUpWithGoogle } = useUser();
  ...
  useEffect(() => {
    ...
    if (user.isWearableConnected) return;
        ...
        <div class="flex flex-wrap items-center mt-20 text-left text-center">
          ...
          <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
            ...
            <p class="sm:text-lg mt-6">
              Education is key to effective diabetes management. Our app serves
              as a an interactive tool designed to educate and empower kids to
